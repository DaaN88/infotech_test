...
class m260219_120000_create_rbac_tables extends CDbMigration
{
    public function up()
    {
        ...
        // Roles
        $this->insert('authitem', ['name' => 'guest', 'type' => 2, 'description' => 'Гость']);
        $this->insert('authitem', ['name' => 'user', 'type' => 2, 'description' => 'Пользователь']);
        $this->insert('authitem', ['name' => 'admin', 'type' => 2, 'description' => 'Администратор']);
    }
